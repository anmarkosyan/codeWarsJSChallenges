...
console.log(replaceCommon('hi enrich bedeck sleep grace furbish run gushy garnish furbish at', 'h'));//'hi hnrich bhdhck slhhp grach furbish run gussy garnish furbish at'

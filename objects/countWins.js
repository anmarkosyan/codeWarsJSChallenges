...
const countWins = (winnerList, country) => {
    //#1 way using for... of and for ... in loops
    // let count = 0;
    // for(let el of winnerList){
    //     for(let key in el){
    //         if(el[key] === country) count++;
    //     }
    //
    // }
    // return count;

    //#2 using only for ... of loop
    // let count = 0;
    // for(let el of winnerList){
    //     if(el.country === country)  count++;
    //  }
    //return count;
...
console.log(countWins(winnerList1, 'Armenia'));//0
console.log(countWins(winnerList1, 'Spain'));//1